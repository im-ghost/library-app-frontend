...
export const initializeStore = (preloadedState = {}) => {
  return create((set, get) => ({
    ...
    ...preloadedState,
getUser:()=>window.localStorage.getItem("user") || null,
logoutUser: () =>{ 
...
registerUser: (user) => {window.localStorage.setItem("library-user",user)
...
export function useCreateStore(serverInitialState) {
  // Server side code: For SSR & SSG, always seeuse a new store.
